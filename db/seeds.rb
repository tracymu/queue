...
crinitis = Restaurant.create(:name => 'Crinitis', :website => 'http://www.crinitis.com.au/', :location => 'Sydney')
Restaurant.create(:name => 'The Grounds', :website => 'http://groundsroasters.com/ ', :location => 'Sydney')
Restaurant.create(:name => 'Movida', :website => 'http://movida.com.au/sydney/', :location => 'Sydney')
Restaurant.create(:name => 'Momofuku', :website => 'http://momofuku.com/press-kit-post/seiobo/', :location => 'Sydney')
Restaurant.create(:name => 'Mr Wong', :website => 'http://merivale.com.au/mrwong/', :location => 'Sydney')
Restaurant.create(:name => 'Jamie\'s Italian', :website => 'http://www.jamieoliver.com/italian/australia/home', :location => 'Sydney')
Restaurant.create(:name => 'Devon Cafe', :website => 'http://www.devoncafe.com.au/', :location => 'Sydney')
Restaurant.create(:name => 'Chur Burger', :website => 'http://www.churburger.com.au/', :location => 'Sydney')
Restaurant.create(:name => 'Grain Store', :website => 'http://www.grainstore.com.au/', :location => 'Melbourne')
Restaurant.create(:name => 'Hammer and Tong', :website => 'http://www.hammerandtong.com.au/', :location => 'Melbourne')
Restaurant.create(:name => 'Wonderbao', :website => 'http://www.wonderbaokitchen.com.au/', :location => 'Melbourne')
Restaurant.create(:name => 'Manchester Press', :website => 'http://www.8oz.com.au/', :location => 'Melbourne')
Restaurant.create(:name => 'Meatball and Wine Bar', :website => 'http://www.meatballandwinebar.com.au/', :location => 'Melbourne')
Restaurant.create(:name => 'Cumulus Inc', :website => 'http://cumulusinc.com.au/', :location => 'Melbourne')
Restaurant.create(:name => 'Mamak', :website => 'http://www.mamak.com.au/', :location => 'Melbourne')
Restaurant.create(:name => 'Mamasita', :website => 'http://www.mamasita.com.au/', :location => 'Melbourne')
Restaurant.create(:name => 'Two Birds One Stone', :website => 'http://www.twobirdsonestonecafe.com.au/', :location => 'Melbourne')
Restaurant.create(:name => 'Moose and Gibson', :website => 'http://www.mooseandgibson.com/', :location => 'Brisbane')
Restaurant.create(:name => 'New Shanghai', :website => 'http://www.newshanghai.com.au/splash.php', :location => 'Brisbane')
Restaurant.create(:name => 'The Bun Mobile', :website => 'http://www.thebunmobile.com.au/', :location => 'Brisbane')
Restaurant.create(:name => 'The Burrow', :website => 'http://theburrowwestend.com.au/', :location => 'Brisbane')
Restaurant.create(:name => 'Depo', :website => 'http://the-depo.com/', :location => 'Brisbane')
Restaurant.create(:name => 'Chester Street', :website => 'http://www.chesterstreet.com.au/', :location => 'Brisbane')
Restaurant.create(:name => 'Shady Palms Cafe', :website => 'http://shadypalmscafe.com/', :location => 'Brisbane')
Restaurant.create(:name => 'Passion Tree', :website => 'http://www.passiontree.com.au/', :location => 'Brisbane')
Restaurant.create(:name => 'Alfred and Constance', :website => 'http://www.alfredandconstance.com.au/', :location => 'Brisbane')
Restaurant.create(:name => 'Vintaged Bar and Grill', :website => 'http://www.alfredandconstance.com.au/', :location => 'Brisbane')
